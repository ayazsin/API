    ...
    public void get11(){
        ...
        response.
                ...
                body("meta.pagination.limit", equalTo(20),
                        ...
                        "data.name", hasItems("Chandraayan Kakkar", "Triloki Nath Khatri", "Rukhmani Naik"));
        ...
        List<String> expectedNamesList = Arrays.asList("Chandraayan Kakkar", "Triloki Nath Khatri", "Rukhmani Naik");
