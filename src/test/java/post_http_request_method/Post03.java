...
public class Post03 extends AgroMonitoringApiBaseUrl {
     ...
     */
        ...
        public void post03(){
            ...
            //Add more key-values into the request
            ...
            assertEquals(requestBody.coordinates[0][1][0]+"",((Map)((Map)responseBody.get("geo_json")).get("geometry")).get("coordinates").toString().substring(25,34));
